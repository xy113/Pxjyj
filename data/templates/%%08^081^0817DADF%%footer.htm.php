...
<div class="area">
	<div class="flinkbar" id="jumpbar">
		<select onchange="window.open(this.value)"> 
			<option selected="selected" value="">国务院部门网站</option>
			...
			<option value="http://www.chinasafety.gov.cn/mjweb/mjindex07.htm">煤矿安监局</option>
			...
			<option value="http://www.3g.gov.cn/">国务院三峡办</option>
	  	</select>

		<select onchange="window.open(this.value)"> 
		   <option selected="selected" value="">教育部相关网站</option>
		   <option value="http://www.ssmz.edu.cn/">中国少数民族教育网</option>
		   <option value="http://www.edu.cn/">中国教育和科研计算机网</option>
		   <option value="http://www.chinadegrees.cn">中国学位与研究生教育信息网</option>
		   <option value="http://www.chinaedu.edu.cn/">中国教育信息网</option>
		
		   <option value="http://www.csc.edu.cn/">国家留学网</option>
		   <option value="http://www.eol.cn/">中国教育在线</option>
		   <option value="http://www.myjob.edu.cn/">中国高校毕业生就业服</option>
		   <option value="http://www.cetv.edu.cn/">中国教育电视台网站</option>
		   <option value="http://www.hie.edu.cn/">中国高教改革与发展网</option>
		   <option value="http://www.uast.com.cn/">高校农业科技与教育联</option>
		
		   <option value="http://www.jsj.edu.cn/">教育涉外监管信息网</option>
		   <option value="http://www.chsi.com.cn/">中国高等教育学生信息</option>
		   <option value="http://www.21caas.com/">中国院校后勤信息网</option>
		   <option value="http://www.chinayz.com.cn/index.htm">中国研究生招生信息网</option>
		   <option value="http://www.cscse.edu.cn/">中国留学网</option>
		   <option value="http://www.itat.com.cn/">全国信息技术应用培训</option>
		
		   <option value="http://www.cbe21.com/">中国基础教育网</option>
		   <option value="http://www.cvae.edu.cn/">中国职业教育与成人教</option>
		   <option value="http://166.111.180.5/">全国高等学校精品课程</option>
		   <option value="http://www.paper.edu.cn/">中国科技论文在线</option>
		   <option value="http://www.meeting.edu.cn/">中国学术会议在线</option>
		   <option value="http://www.china-language.gov.cn/">中国语言文字网</option>
		
		   <option value="http://www.e-chinaedu.cn/">中国教育信息化网</option>
		   <option value="http://www.jyb.cn/">中国教育新闻网</option>
		   <option value="http://www.jycbxx.net.cn/">教育出版信息网</option>
		   <option value="http://www.cern.net.cn/">中国教育资源网</option>
		   <option value="http://yz.chsi.cn/">中国研究生招生信息网</option>
		   <option value="http://ycjy.moe.edu.cn/">农村中小学现代远程教</option>
		
		   <option value="http://www.ceat.edu.cn/">中国教育干部培训网</option>
		   <option value="http://www.cupa.com.cn/">中国校长协会网</option>
		   <option value="http://www.cbern.gov.cn/">国家基础教育资源网</option>
		   <option value="http://www.cedf.org.cn/">中国教育发展基金会网站</option>
		   <option value="http://www.cksp.edu.cn/">长江学者奖励计划</option>
		   <option value="http://www.eachina.org.cn/">教育部基础教育质量监</option>
		
		   <option value="http://www.jsjjh.org.cn/">中国中小学幼儿教师奖</option>
		   <option value="http://www.csh.edu.cn/">中国学生体质健康网</option>
		   <option value="http://journal.hep.com.cn/">中国学术前沿期刊网</option>
		   <option value="http://www.wei.moe.edu.cn/">世界教育信息网</option>
	  </select>

		<select onchange="window.open(this.value)"> 
		   <option selected="selected" value="">教育部直属高校网站</option>
		   ...
		   <option value="http://www.jlu.edu.cn/newindex.html" >吉林大学</option>
		   ...
		   <option value="http://www.sytu.edu.cn/" >江南大学</option>
		   ...
		   <option value="http://www.hust.edu.cn/index.html" >华中科技大学</option>
		...
		<select onchange="window.open(this.value)"> 
		   <option selected="selected" value="">地方教育机构网站</option>
		   <option value="http://www.bjedu.gov.cn/">北京市教育委员会</option>
		   <option value="http://www.tjmec.gov.cn/">天津市教育委员会</option>
		   <option value="http://www.hee.cn/">河北省教育厅</option>
		
		   <option value="http://www.sxedu.gov.cn/">山西省教育厅</option>
		   <option value="http://www.nmgov.edu.cn/">内蒙古教育厅</option>
		   <option value="http://www.lnein.gov.cn/">辽宁省教育厅</option>
		   <option value="http://www.jledu.gov.cn/">吉林省教育厅</option>
		   <option value="http://www.hlje.net/">黑龙江省教育厅</option>
		   ...
		   <option value="http://www.ahedu.gov.cn/">安徽省教育厅</option>
		   <option value="http://www.fjedu.gov.cn/">福建省教育厅</option>
		   <option value="http://www.jxedu.gov.cn/">江西省教育厅</option>
		   <option value="http://www.sdedu.gov.cn/">山东省教育厅</option>
		
		   <option value="http://www.hadoe.edu.cn/">河南省教育厅</option>
		   ...
		   <option value="http://www.gxedu.gov.cn/">广西壮族自治区教育厅</option>
		   <option value="http://edu.hainan.gov.cn/">海南省教育厅</option>
		
		   <option value="http://www.cqjw.gov.cn/">重庆市教育委员会</option>
		   <option value="http://www.scedu.net/">四川省教育厅</option>
		   <option value="http://www.guizhou.edu.cn/">贵州省教育厅</option>
		   <option value="http://www.ynjy.cn/">云南省教育厅</option>
		   <option value="http://www.xzedu.com.cn/">西藏自治区教育厅</option>
		   <option value="http://www.snedu.gov.cn/">陕西省教育厅</option>
		
		   <option value="http://www.gsedu.gov.cn/">甘肃省教育厅</option>
		   <option value="http://www.qhedu.gov.cn/">青海省教育厅</option>
		   <option value="http://nxedu.com/tzjg/dld/">宁夏回族自治区教育厅</option>
		   <option value="http://www.xjedu.gov.cn/">新疆维吾尔自治区教育厅</option>
		   <option value="http://www.dledu.com/">大连市教育局</option>
		   <option value="http://www.qdedu.gov.cn/">青岛市教育局</option>
		
		   <option value="http://nbedu.net.cn/">宁波市教育委员会</option>
		   <option value="http://www.xmedu.gov.cn/">厦门市教育局</option>
		   <option value="http://www.sz.edu.cn/">深圳市教育局</option>
	  </select>
	</div>
	<div id="footer">
		<div class="bottomnav">
			<a href="map.php">网站地图</a> |
			<a href="leadmail.php">局长邮箱</a> |
			<a href="forum.php">民意调查</a> |
			<a href="about.php?id=1">使用帮助</a> |
			<a href="about.php?id=2">联系我们</a> |
			<?php echo $this->_tpl_vars['config']['statcode']; ?>

		</div>
		<div class="copyright"><?php echo $this->_tpl_vars['config']['copyright']; ?>
  ICP证：<a href="http://www.miibeian.gov.cn/" target="_blank"><?php echo $this->_tpl_vars['config']['icp']; ?>
</a></div>
		<p>
			地址：<?php echo $this->_tpl_vars['config']['ct_address']; ?>
 邮编：<?php echo $this->_tpl_vars['config']['ct_postcode']; ?>
<br />
			联系电话：<?php $_from = $this->_tpl_vars['contact']['tel']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['tel']):
?>　<?php echo $this->_tpl_vars['tel']; ?>
<?php endforeach; endif; unset($_from); ?>
			主办单位：盘县教育局　技术支持：<a href="http://www.toking.cc" target="_blank">拓垦科技</a>
		</p>
	</div>
</div>
<div class="blank"></div>
